                        ...
                        <div className="flex flex-col gap-y-4">
                            ...
                            <ul className="flex items-center gap-x-5">
                                { product.meta.map(item => (
                                    <li className="px-2 py-1 w-8 text-center rounded-lg border-2 border-gray-400 cursor-pointer">{ item.size }</li>
                                )) }
                            </ul>
                        </div>
                        <div>
                            ...
                            <ol className="flex items-center gap-x-5">
                                { colors.map(item => (
                                    <li className="w-8 h-8 rounded-full">{ item.name }</li>
                                )) }
                            </ol>
                        </div>
                        ...
                        { product.delivery && (
                            <ul className="border-t-2 border-gray-300 py-10 flex flex-wrap">
                                { product.delivery.payment && (
                                    <li className="flex-[1_1_50%] flex gap-x-6 items-center font-semibold text-gray-700">
